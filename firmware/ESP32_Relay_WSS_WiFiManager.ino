...
// Pin ADC Sensor Pembagi Tegangan 5V (Pin D33 / GPIO 33 - ADC1 Channel 5)
const int VOLTAGE_ADC_PIN = 33; 

// Parameter Resistor Pembagi Tegangan (Voltage Divider 10k + 10k)
// 5V masuk -> R1 (10k) -> Node D33 -> R2 (10k) -> GND (Vout max 2.5V safe untuk ADC ESP32)
...
float readVoltage5V() {
  ...
  // Hitung Tegangan Asli Sumber (5V) berdasarkan rumus Voltage Divider:
  // Vin = Vadc * ((R1 + R2) / R2)
